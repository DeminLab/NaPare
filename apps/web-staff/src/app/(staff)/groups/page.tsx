...
import { Card, Badge, EmptyState, Skeleton, SearchInput, RequestState } from '@/components/ui';
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      {loading ? (
        ...
        <RequestState title="Не удалось загрузить группы" description={error} onRetry={loadGroups} />
      ) : filtered.length === 0 ? (
        <EmptyState
