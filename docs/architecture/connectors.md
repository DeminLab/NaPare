...
Слой коннекторов обеспечивает получение расписания из внешних источников и приведение к единой модели `NormalizedLesson`. См. [ADR-0006](../decisions/0006-connectors-layer.md).
